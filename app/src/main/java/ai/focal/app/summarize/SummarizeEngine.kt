...
import ai.focal.app.llm.InferenceEngine
import ai.focal.app.llm.ModelInfo
import ai.focal.app.llm.ProviderConfig
import ai.focal.app.llm.ProviderCapabilities
...
class SummarizeEngine(
    ...
    suspend fun summarizeChapters(
        chapters: List<ai.focal.app.source.FileTextExtractor.Chapter>,
        bookOverview: String,
