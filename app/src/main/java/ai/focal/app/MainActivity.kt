...
import ai.focal.app.ui.CrashScreen
import ai.focal.app.ui.ModelsScreen
import ai.focal.app.ui.SettingsScreen
import ai.focal.app.ui.SetupScreen
import ai.focal.app.ui.FocalTheme
import ai.focal.app.ui.SummaryScreen
import ai.focal.app.ui.SummaryViewModel
        ...
        setContent {
            FocalTheme {
                ...
                val exportLauncher = androidx.activity.compose.rememberLauncherForActivityResult(
                    ...
                    if (uri != null && p != null) {
                        runCatching {
                            ai.focal.app.data.Exporter.write(
                ...
                LaunchedEffect(pending) {
                    ...
                    exportLauncher.launch(
                        ai.focal.app.data.Exporter.suggestedName(p.title, p.format))
                }
